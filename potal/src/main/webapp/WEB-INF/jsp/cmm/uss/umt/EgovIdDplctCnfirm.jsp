...
<body>
    <form id="idCheckForm" name="checkForm" action ="<c:url value='/uss/umt/cmm/EgovIdDplctCnfirm.do'/>">
    ...
    <div class="buttons" style="padding-top:10px;padding-bottom:10px; padding-left: 82px;">
